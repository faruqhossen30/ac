            ...
            <ul id="side-menu">
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarSubcategory">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{route('sub-category.index')}}">All sub Category</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarDeposit">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{route('admin.deposit.list')}}">All Deposit</a>
                            </li>
                            <li>
                                <a href="{{route('admin.deposit.list')}}">Approved Deposits</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapse" id="sidebarUser">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{route('admin.user.list')}}">All User</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapse" id="sidebarBibs">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{route('admin.bids')}}">All Bids</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapse" id="sidebarAdmin">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{route('admin.adminlist')}}">All Admin</a>
                            </li>
                            <li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarProduct">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{route('admin.product.list')}}">All Product</a>
                            </li>
                            <li>
