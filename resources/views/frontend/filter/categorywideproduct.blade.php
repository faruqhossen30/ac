                                                            ...
                                                            <ul class="list-inline d-flex justify-content-between align-items-center"
                                                                ...
                                                                <span>
                                                                    <li class="list-inline-item">
                                                                        Category: <a href="{{route('category', $product->category->slug)}}">{{$product->category->name}}</a>
                                                                    </li>
                                                                    <li class="list-inline-item">
                                                                        SubCategory: <a href="{{route('subcategory', $product->subcategory->slug)}}">{{$product->subcategory->name}}</a>
                                                                    </li>
