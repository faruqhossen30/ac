                    ...
                    @foreach ($products as $product)
                        ...
                        <div class="row justify-content-center mb-3">
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card" style="box-shadow: 0px 9px 20px 0px rgb(22 26 57 / 36%)">
                                            ...
                                            <div class="card-footer d-flex justify-content-between"
                                                ...
                                                <div>
                                                    ...
                                                    <a href="{{ route('singleproduct', $product->slug) }}"
                                                        class="custom-button"
                                                        style="font-size: 12px; padding:0 25px;background:-webkit-linear-gradient(166deg, #f22876 0%, #942dd9 100%)">
                                                        Submit Now !</a>
                                                </div>
                                            </div>
                                        </div>
