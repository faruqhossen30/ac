    ...
    <section class="product-details padding-bottom mt--240 mt-lg--440">
        <div class="container">
            <div class="product-details-slider-top-wrapper">
                <div class="product-details-slider owl-theme owl-carousel owl-loaded owl-drag" id="sync1">



                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-6840px, 0px, 0px); transition: all 1s ease 0s; width: 13680px;"><div class="owl-item cloned" style="width: 1140px;"><div class="slide-top-item">
                        <div class="slide-inner">
                            <img src="{{asset('frontend')}}/assets/images/product/product4.png" alt="product">
                        </div>
                    </div></div><div class="owl-item cloned" style="width: 1140px;"><div class="slide-top-item">
                        <div class="slide-inner">
                    ...
                    </div></div><div class="owl-item" style="width: 1140px;"><div class="slide-top-item">
                        <div class="slide-inner">
                            <img src="{{asset('frontend')}}/assets/images/product/product1.png" alt="product">
                        </div>
                    </div></div><div class="owl-item" style="width: 1140px;"><div class="slide-top-item">
                        <div class="slide-inner">
                    ...
                    </div></div><div class="owl-item active" style="width: 1140px;"><div class="slide-top-item">
                        <div class="slide-inner">
                            <img src="{{asset('frontend')}}/assets/images/product/product4.png" alt="product">
                        </div>
                    </div></div><div class="owl-item" style="width: 1140px;"><div class="slide-top-item">
                    ...
                    </div></div></div></div><div class="owl-nav disabled"><div class="owl-prev">prev</div><div class="owl-next">next</div></div><div class="owl-dots disabled"></div><div class="owl-thumbs"></div></div>
            </div>
            <div class="product-details-slider-wrapper">
                <div class="product-bottom-slider owl-theme owl-carousel owl-loaded owl-drag" id="sync2">
                ...
                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1010px;"><div class="owl-item active" style="width: 168.333px;"><div class="slide-bottom-item">
                        <div class="slide-inner">
                            <img src="{{asset('frontend')}}/assets/images/product/01.png" alt="product">
                        </div>
                    </div></div><div class="owl-item active" style="width: 168.333px;"><div class="slide-bottom-item">
                        <div class="slide-inner">
                    ...
                    </div></div><div class="owl-item active synced" style="width: 168.333px;"><div class="slide-bottom-item">
                        <div class="slide-inner">
                ...
                <div class="col-lg-4">
                    <div class="product-sidebar-area">
                        <div class="product-single-sidebar mb-3">
                            ...
                            <div class="countdown">
                                <div id="bid_counter1">0d  : 12h  : 37m  : 41s</div>
                            </div>
                    ...
                    <div class="tab-details-content">
                        <div class="header-area">
                            ...
                            <div class="item">
                                ...
                                <p>At this time Sbidu only accepts bidders from the United States, Canada and Mexico on Vehicles and Heavy Industrial Equipment. The Submit Now ! button will appear on auctions where you are qualified to place a bid.</p>
                            </div>
                            <div class="item">
