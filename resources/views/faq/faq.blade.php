        ...
        <div class="row mb--50">
            ...
            <div class="col-lg-4 mb-50">
                <aside class="sticky-menu">
                    <div class="faq-menu bg_img mb-30" data-background="{{asset('frontend')}}/assets/images/faq/faq-menu.png" style="background-image: url(&quot;./assets/images/faq/faq-menu.png&quot;);">
                        <ul id="faq-menu">
                            <li class="nav-item">
